...
class _$NewsModelImpl extends _NewsModel {
  ...
  @override
  String toString() {
    return 'NewsModel(id: $id, title: $title, content: $content, media: $media, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, content,
      const DeepCollectionEquality().hash(_media), createdAt);
...
abstract class _NewsModel extends NewsModel {
  const factory _NewsModel(
      ...
      final List<String>? media,
      required final DateTime createdAt}) = _$NewsModelImpl;
